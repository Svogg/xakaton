...
async def add_event(event: Event, current_session: get_async_session):
...
async def add_excursion(excursion: Excursion, current_session: get_async_session):
...
async def add_restaurant(restaurant: Restaurant, current_session: AsyncSession):
